...
const CreateUserForm = () => {
    ...
    const generateStrongPassword = ()=>{
        ...
        // show();
        setAnimateIcon(true);
        setTimeout(() => setAnimateIcon(false), 1000); // matches animation duration
    }
                    ...
                    <form onSubmit={handleSubmit} className="createUserForm w-[100%] h-[100%] mt-[1rem] bg-[#ffffff]/60 px-[1rem] py-[2rem] rounded-[1rem] z-[30] flex flex-col gap-[1.5rem]">
                        ...
                        <div className="passwordDiv flex justify-between">
                            ...
                            <div className="autoGeneratePassword w-[8%]  flex justify-center items-center">
                                <button
                                    type="button"
                                    className="w-full h-full rounded-lg border-2 border-gray-200 bg-white px-4 py-2 flex justify-center items-center transition-all ease-in-out duration-250 hover:scale-[0.9]"
                        ...
                        <div className="inputField w-[100%] h-[3rem] flex flex-col justify-center items-center relative">
                            ...
                            <input type="number" value={formData.phone} onChange={handleChange}  name="phone" id="phone" className={`border-[.1rem]  px-[.5rem] py-[.5rem]  outline-none w-[100%] h-[100%] rounded-[.4rem] `} placeholder="joe@example.com"  required/>
                        ...
                        <div className="inputField w-[100%] h-[3rem] flex flex-col justify-center items-center relative">
                            ...
                            <select
                                ...
                                className="border px-2 py-2 outline-none w-full h-full rounded-md"
                                defaultValue=""
                            >

        ...
        <>
            <div className="aboutSection w-[100%] bg-[#5E788F]/85 px-[3.37rem] text-[#D8DFE5]  py-[2.8rem] z-[10]">
                ...
                <div className="innerAboutContainer w-[100%] h-[100%] bg-[#FFFFFF]/35 rounded-[.5rem] px-[3.12rem] py-[1.5rem] z-[10]">
                    ...
                    {/* Lower Container */}
                    <div className="lowerContainer w-[100%] z-[10] flex gap-24 justify-between align-middle items-center">
                        ...
                        <div className="leftAboutContainer w-[65%] z-[10]">
                            ...
                            <div className="descriptionContainer text-[1.12rem] tracking-wide mt-[1rem]">Join thousands of marketers, creators, and businesses who are revolutionizing their social media presence with ElevatrX. Experience firsthand how our AI-driven tools effortlessly streamline your content creation, scheduling, and analytics—giving you the freedom to focus on growing your business.</div>
                        ...
                        {/* Right Container */}
                        <div className=" flex gap-2 rounded-lg bg-[#FF7171]">
                            <div className='h-[321px] w-[415px] rounded-[10px] bg-[#9B9B9BCC]'></div>

  ...
  return (
    ...
    <div className='flex justify-between items-center'>
      ...
      <Image src={linkdinicon} alt=''></Image>
          ...
          {/* third div */}
          <div>
          <div className='bg-[#ffffff]/60  rounded-xl p-5 w-full max-w-[639px] min-w-[212px] flex-grow-0'>
          <div className='flex flex-col gap-2'>
            <div>
            <h1 className='font-semibold text-[18px]'>Mentions & Comments</h1>
            <p className='text-[#9E9E9E] text-[13px]'>Search Across Your Dashboard</p>
            </div>
              <div className='flex justify-between items-center bg-white z-20 p-2 rounded-lg '>
                <Image src={profile} alt=''></Image>
                <p >@user1:“Love this post i want to design...<span className='text-[#9E9E9E]'>(2 Hourse ago)</span></p>

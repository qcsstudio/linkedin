        ...
        <>
            ...
            <div className="loginContainer w-[100%] h-[100vh]  flex text-black bg-[#ffffff] ">
                ...
                <div className="rightContainer  w-1/2 h-[100%] bg-gradient-to-r p-10 from-purple-300 flex flex-col justify-center items-center  to-blue-200  ">
                    {/* Form Container */}  <div className="inputContainer w-[100%] gap-2  justify-end  flex items-center ">
                    ...
                    <form method="POST" onSubmit={handelSubmit} className="formContainer w-[70%]   p-[2rem] justify-center items-start  flex flex-col gap-[1rem]">
                        <p className="heading text-[1.8rem] font-bold text-center">Log in</p>
                        <p className=" text-purple-500 ">Welcome back! Enter email and pasword </p>
                        ...
                        <div className="inputContainer w-full h-[4rem] px-[1.3rem]  rounded-[.5rem] border border-white bg-[#ffffff]/30 flex items-center gap-[3rem]">
                            ...
                            <input id="email" placeholder="Enter Your Email" value={formData.email} onChange={handleChange} type="email" name="email" className="w-[100%] h-[100%] border-none bg-transparent focus:outline-none" required />
                        </div>
                        ...
                        <div className="inputContainer w-[100%] h-[4rem] px-[1.3rem]  rounded-[.5rem] border border-white bg-[#ffffff]/30 flex items-center gap-[3rem]">
                            <input id='password' placeholder="Enter Your Password" value={formData.password} onChange={handleChange} type={showPassword ? "text" : "password"} name="password" className="w-[100%] h-[100%]  border-none bg-transparent  focus:outline-none " required />

...
const AddCard = ({setAddAccount,addAccount}) => {
    return (
        <>
            <div className="card p-[2px] min-w-[32%] max-w-[32%] min-h-[15.3rem] max-h-[15.3rem]
             bg-gradient-to-l from-[rgba(177,185,248,1)] to-[rgba(176,248,255,1)] rounded-[.5rem] 
             overflow-hidden flex justify-center items-center z-[100] ">

                {/* Card Inner Container */}
                <div className="innerCard w-[100%] h-[100%] bg-[#ffffff]/80 rounded-[.4rem]">

      ...
      <div className="w-full bg-white/50 p-4 rounded-lg shadow-md">
        ...
        <div className="bg-gray-100 rounded-lg">
          ...
          {topPosts.map((post, i) => {
            ...
            const shortText = post.text?.split(" ").slice(0, 4).join(" ") + "...";
  
            return (
              <div
                key={i}
                className="flex p-4 items-center justify-between py-3 border-b last:border-none cursor-pointer hover:bg-gray-200 transition"

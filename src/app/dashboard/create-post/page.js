      ...
      <div className="flex items-center gap-2 flex-nowrap overflow-x-auto">
        ...
        <button
          ...
          onClick={(e) => {
            e.stopPropagation();
            setSelectedaccount(
              selectedaccount.filter((c) => c.code !== option.code)
            );
          }}
        >
          <CiCircleRemove />
...
>>>>>>> d07242e (omkar/ create post  section)
        ...
        <div className="p-5 flex flex-col gap-3 bg-white/50 rounded-lg">
          <div className="flex justify-end gap-3">
            ...
            <button className="bg-[#4379EE] text-white px-4 py-2 rounded-md text-sm">
              Publish
            </button>
          </div>
        </div>
